...
IE: new-url-title"></i></h5>
                    ...
                    <div class="col-md-4">
                        <h5>Sidebars</h5>
                        <?php echo form_dropdown('sidebars',$sidebars,array(),array('class'=>'chosen-select-no-single')); ?>
                    </div>

                    <div class="col-md-4">
                        <h5>Slider</h5>
                        <?php echo form_dropdown('sliders',$sliders,array(),array('class'=>'chosen-select-no-single')); ?>
                    </div>
